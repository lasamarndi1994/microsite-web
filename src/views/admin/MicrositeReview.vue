        ...
        <v-card flat class="rounded-xl pa-8 card-padding" elevation="0">
          ...
          <div class="mb-8">
            <div class="d-flex align-center justify-space-between mb-1">
              <div>
                <h1 class="fs-24 font-weight-bold text-grey-darken-3 mb-1">Review Microsite Submission</h1>
          ...
          <div class="mb-8">
            ...
            <v-row align="center">
              ...
              <v-col cols="12" md="8" class="d-flex align-center justify-end">
                <div class="product-launch-pill" style="width: fit-content;">
          ...
          <div class="mb-8">
            ...
            <div class="text-box-style">
              ...
              <div class="text-body-2 text-grey-darken-2">
                A passionate digital creator helping brands grow through web development, design, and strategic digital marketing. With 6+ years of experience, I build modern, conversion-focused digital experiences.
              </div>
            </div>
          </div>
              ...
              >
                <div class="d-flex fill-height align-center justify-center banner-overlay">
                  <div class="text-center text-white px-6">
                    ...
                    <p class="text-body-1">
                      A passionate digital creator helping brands grow through web development, design, and strategic digital marketing.
                    </p>
                  </div>
                </div>
              </v-img>
          ...
          <div class="mb-8">
            ...
            <v-textarea 
              ...
              placeholder="Please review the microsite carefully and provide feedback"
              variant="outlined" 
              rows="2" 
