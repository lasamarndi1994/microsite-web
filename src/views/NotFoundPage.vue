      ...
      <v-container>
        <v-row justify="center">
          <v-col cols="12" md="8" lg="6" class="text-center">
            <v-card class="rounded-xl pa-8 pa-md-12" elevation="8">
              <div class="mb-6">
                <h1 class="display-1 font-weight-bold mb-2" style="font-size: 120px; color: var(--secondary-color);">404</h1>
                <h2 class="text-h4 font-weight-bold mb-4 text-grey-darken-3">Page Not Found</h2>
              ...
              <div class="d-flex flex-column flex-sm-row gap-6 justify-center">
                <v-btn 
                  class="btn-secondary text-white text-capitalize m-2" 
                ...
                <v-btn 
                  variant="outlined" 
                  class="text-secondary-color text-capitalize ml-4" 
